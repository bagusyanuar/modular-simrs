import { MainLayout, type NavItem } from '@genmedical/ui/layout';
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: 'Pasien', path: '/master-data/pasien' },
      { label: 'Dokter', path: '/master-data/dokter' },
      { label: 'Poli', path: '/master-data/poli' },
    ],
  },
  {
    label: 'Rawat Jalan',
